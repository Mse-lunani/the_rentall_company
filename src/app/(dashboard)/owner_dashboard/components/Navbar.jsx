// src/app/owner_dashboard/components/Navbar.jsx
"use client";
              ...
              <div className="dropdown-shortcuts-list scrollable-container">
                <div className="row row-bordered overflow-visible g-0">
                  <div className="dropdown-shortcuts-item col">
                    ...
                    <a href="/owner_dashboard/property_records" className="stretched-link">
                      View Buildings
                    </a>
                  ...
                  <div className="dropdown-shortcuts-item col">
                    ...
                    <a href="/owner_dashboard/units" className="stretched-link">
                      All Units
                    </a>
                ...
                <div className="row row-bordered overflow-visible g-0">
                  <div className="dropdown-shortcuts-item col">
                    ...
                    <a href="/owner_dashboard/tenants" className="stretched-link">
                      View Tenants
                    </a>
                  ...
                  <div className="dropdown-shortcuts-item col">
                    ...
                    <a href="/owner_dashboard/profile" className="stretched-link">
                      My Profile
                    </a>
                ...
                <div className="row row-bordered overflow-visible g-0">
                  <div className="dropdown-shortcuts-item col">
                    ...
                    <a href="/owner_dashboard/payments" className="stretched-link">
                      View Payments
                    </a>
                  ...
                  <div className="dropdown-shortcuts-item col">
                    ...
                    <a href="/owner_dashboard/maintenance" className="stretched-link">
                      Maintenance
                    </a>
