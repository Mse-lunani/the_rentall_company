  ...
  return (
    <div className="card">
      <div className="card-header">
        <h4 className="card-title">Bulk Upload Tenant Assignments</h4>
        <p className="text-muted mb-0">
          Upload a CSV file to assign multiple existing tenants to units at once
        </p>
      </div>
      <div className="card-body">
                        ...
                        <tbody>
                          {result.assignments.map((assignment, idx) => (
                            <tr key={idx}>
                              ...
                              <td>
                                {assignment.unit_name} (ID: {assignment.unit_id}
                                )
                              </td>
        ...
        <div className="mt-4">
          ...
          <ul className="text-muted small">
            <li>
              <strong>Required columns:</strong> tenant_id, unit_name,
              start_date
            </li>
            <li>
              <strong>Optional columns:</strong> monthly_rent, deposit_paid,
              lease_terms, notes
            </li>
            <li>
            ...
            <li>
              <strong>Tenant IDs:</strong> Must exist in your database
            </li>
            <li>
